 ...
 */
public class BasicCoin extends PlayerItem {
    ...
    Texture spin1 = new Texture("SPA/Items/Coin/Spin/1.png");
    Texture spin2 = new Texture("SPA/Items/Coin/Spin/2.png");
    Texture spin3 = new Texture("SPA/Items/Coin/Spin/3.png");
    Texture spin4 = new Texture("SPA/Items/Coin/Spin/4.png");
    Texture[] spinTextures = {spin1, spin2, spin3, spin4};
    ...
    public BasicCoin(float x, float y, float velX, float velY, int width, int height) {
    ...
    public void draw(SpriteBatch batch) {
        ...
        batch.draw(spinTextures[animImage], x, y, width,height);
