 ...
 */
public class SkeletonFloatingHead extends Enemy {
    ...
    Texture attackImage1 = new Texture("SPA/Enemy/skelehead/Attack/1.png");
    Texture attackImage2 = new Texture("SPA/Enemy/skelehead/Attack/2.png");
    Texture attackImage3 = new Texture("SPA/Enemy/skelehead/Attack/3.png");
    Texture attackImage4 = new Texture("SPA/Enemy/skelehead/Attack/4.png");
    Texture attackImage5 = new Texture("SPA/Enemy/skelehead/Attack/5.png");
    Texture attackImage6 = new Texture("SPA/Enemy/skelehead/Attack/6.png");
    Texture attackImage7 = new Texture("SPA/Enemy/skelehead/Attack/7.png");
    Texture attackImage8 = new Texture("SPA/Enemy/skelehead/Attack/8.png");
    ...
    public SkeletonFloatingHead(int x, int y) {
        this.x = x;
        this.y = y;
        this.width = 22;
        this.height = 22;
        attackImages = new Texture[]{
                attackImage1,
                attackImage2,
                attackImage3,
                attackImage4,
    ...
    private void moveEnemy(int playerX, int playerY, Array<EnemyBullet> enemyBullets) {
        ...
        if (!isShooting) {
            ...
            currAttackFrame = 7 - ((shootTime - 40) / 5);
            if (currAttackFrame >  7) {
                currAttackFrame = 7;
            }
    ...
    public void draw(SpriteBatch batch) {
        ...
        if (!isShooting) {
            ...
            batch.draw(attackImages[currAttackFrame], x,y,width,height, 0, 0, 11, 11, !facingRight, false);
        }
