 ...
 */
public class FetyrBowman extends Enemy {
    ...
    Texture image1 = new Texture("SPA/Enemy/Fetyr/Crossbow/1.png");
    Texture image2 = new Texture("SPA/Enemy/Fetyr/Crossbow/2.png");
    Texture image3 = new Texture("SPA/Enemy/Fetyr/Crossbow/3.png");
    Texture image4 = new Texture("SPA/Enemy/Fetyr/Crossbow/4.png");
    Texture image5 = new Texture("SPA/Enemy/Fetyr/Crossbow/5.png");
    Texture image6 = new Texture("SPA/Enemy/Fetyr/Crossbow/6.png");
    Texture image7 = new Texture("SPA/Enemy/Fetyr/Crossbow/7.png");
    Texture image8 = new Texture("SPA/Enemy/Fetyr/Crossbow/8.png");
    Texture image9 = new Texture("SPA/Enemy/Fetyr/Crossbow/9.png");
    Texture image10 = new Texture("SPA/Enemy/Fetyr/Crossbow/10.png");

    Texture runImage1 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/1.png");
    Texture runImage2 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/2.png");
    Texture runImage3 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/3.png");
    Texture runImage4 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/4.png");
    Texture runImage5 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/5.png");
    Texture runImage6 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/6.png");
    Texture runImage7 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/7.png");
    Texture runImage8 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/8.png");
    Texture runImage9 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/9.png");
    Texture runImage10 = new Texture("SPA/Enemy/Fetyr/Crossbow/Running/10.png");
    ...
    int timeUntilShoot = maxTimeUntilShoot; // counts down when isShooting = false, when 0 sets isShooting = true;
    ...
    public FetyrBowman(int x, int y) {
        this.x = x;
        this.y = y;
        this.rect.x = this.x;
        this.rect.y = this.y;
        ...
        shootingImages = new Texture[]{
            image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, image6, image5, image4, image3, image2, image1
        };
    ...
    private void moveEnemy(int playerX, Array<EnemyBullet> enemyBullets) {
        if (!isShooting) {
            ...
            if (shootTime > 0) {
                shootTime --;
                if (shootTime == 24) {
                    FetyrCrossbowBolt bolt = new FetyrCrossbowBolt((int)this.x, (int)this.y + 10, facingRight);
                    enemyBullets.add(bolt);
                    if (facingRight) {
                        velX = -2;
                    } else {
                        velX = 2;
    ...
    public void draw(SpriteBatch batch) {
        ...
        if (isShooting) {
            int currentShootingImage = 15 - Math.min((int)Math.floor(((float)shootTime/(float)maxShootTime) * 15), 15);
            batch.draw(shootingImages[currentShootingImage], x,y,width,height, 0, 0, 16,18, !facingRight, false);
        } else if (velX != 0) {
            //using 24 and 36 as width and height because running frames have smaller width than the normal frames used for standing and shooting
            batch.draw(runningImages[currentRunningImage], x,y,24,36,0,0,12,18,!facingRight, false);
        } else {
            batch.draw(image1, x, y, width, height, 0, 0, 16, 18, !facingRight, false);
        }
    }
}
