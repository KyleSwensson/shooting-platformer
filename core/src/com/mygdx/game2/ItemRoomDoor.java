...
/**
 * Created by kyles on 8/15/2016.
 */
public class ItemRoomDoor extends Item {
    ...
    public ItemRoomDoor(float x, float y, float velX, float velY, int width, int height) {
    ...
    public void draw(SpriteBatch batch) {
        ...
        batch.draw(labelImage,x, y+32, width,height);
    }
