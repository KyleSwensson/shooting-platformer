 ...
 */
public class ManaCrystal extends PlayerItem {
    ...
    Texture texture1 = new Texture("SPA/Items/MP1.png");
    Texture texture2 = new Texture("SPA/Items/MP2.png");
    Texture texture3 = new Texture("SPA/Items/MP3.png");
    Texture texture4 = new Texture("SPA/Items/MP4.png");
    Texture texture5 = new Texture("SPA/Items/MP5.png");
